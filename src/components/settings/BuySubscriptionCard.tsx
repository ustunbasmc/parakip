...
const COPY: Record<PlanKind, { title: string; description: string }> = {
  home_premium: {
    ...
    description: "Sınırsız hesap, sınırsız üye (aile bireylerini ekle) ve sınırsız birikim hedefi. Yalnızca bu alanın sahibi satın alabilir.",
  },
  business: {
    title: "İşletme Premium satın al",
    description: "Sınırsız hesap, işlem, borç/alacak, müşteri, tedarikçi kaydı, ekip üyesi ve birikim hedefi.",
  },
};
